const files = [
  {
    ...
    lines: [
      ...
      { text: "> obsidian-sync:2026-03-11", c: "#a78bfa" },
      { text: "> project: SaaS billing platform with multi-provider payments", c: "#fbbf24" },
      { text: "", c: "" },
      ...
      { text: "", c: "" },
      { text: "## structure", c: "#ececec" },
      { text: "- app/ (App Router), components/ui/ (shadcn)", c: "#888" },
    ],
  },
  {
    path: "SPECS/SEED.md",
    ...
    color: "#fbbf24",
    desc: "Architectural DNA — auto-populated from code analysis. Evolves when specs are archived. Commit this.",
    commit: true,
    lines: [
      { text: "# SEED — Architectural DNA", c: "#ececec" },
      { text: "> Evolved from 6 archived specs · 2026-03-11", c: "#fbbf2499" },
      { text: "", c: "" },
      { text: "## Project Overview", c: "#ececec" },
      { text: "SaaS billing platform with multi-provider payments", c: "#b0b0b0" },
      { text: "", c: "" },
      { text: "## File Structure", c: "#ececec" },
      { text: "- app/ (App Router), lib/ (utils), components/ui/", c: "#b0b0b0" },
      { text: "", c: "" },
      ...
      { text: "", c: "" },
      { text: "## Constraints", c: "#ececec" },
      { text: "- Never modify migration files directly", c: "#888" },
    ],
  },
  {
